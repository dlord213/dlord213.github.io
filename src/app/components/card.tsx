...
export default function Card({
  ...
  return (
    <a href={link} className="w-full">
      <div
        className={
          "flex flex-col rounded-lg md:min-h-[15em] overflow-hidden relative transition-all delay-0 duration-500 cursor-pointer justify-center hover:shadow-[0px_0px_25px_2px_rgba(149,_157,_165,_0.2)] hover:translate-x-2 " +
          className
        }
      >
        <img
