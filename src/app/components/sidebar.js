...
export default function Sidebar() {
  ...
  return (
    <div
      className="float-left fixed 2xl:left-40 xl:left-24 left-0 top-0 hidden md:flex flex-col justify-center items-start m-4 bg-[#11130C] text-[#EEF1E9] dark:bg-[#CFF670] dark:text-[#13160E] p-4 rounded-lg gap-2 nav-sidebar max-w-[64px] transition-all duration-500 delay-0 xl:hover:-translate-x-16 z-10"
