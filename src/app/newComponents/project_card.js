...
export default function RenderProjectCard(props) {
  ...
  return (
    <Link href={link} className="w-full">
      <div
        className={
          "flex flex-col rounded-lg md:min-h-[15em] overflow-hidden relative shadow-inner hover:translate-y-1 border-b-8 hover:border-b-[#6A9009] dark:hover:border-b-[#D0F66F] transition-all delay-0 duration-500 cursor-pointer justify-center border-b-[#11130C] dark:border-b-[#F1F3EC] " +
          style
        }
      >
        <img
