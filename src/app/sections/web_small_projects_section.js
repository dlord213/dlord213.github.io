    ...
    <>
      ...
      <div className="flex flex-row flex-wrap gap-2 flex-1">
        <Link href="/web-projects/100-days-of-poetry" className="hidden">
          <button
            className="dark:bg-[#3a31d8] dark:text-[#eae9fc] bg-[#13160E] text-[#EEF1E9] rounded-lg p-2 hover:translate-y-1 transition-all delay-0 duration-500"
            onClick={() => {
        ...
        <Link href="/web-projects/animal-facts-generator">
          <button className="dark:bg-[#3a31d8] dark:text-[#eae9fc] bg-[#13160E] text-[#EEF1E9] rounded-lg p-2 hover:translate-y-1 transition-all delay-0 duration-500">
